...
function Profile(props) {
    return (
        <div className="user-view">
          ...
          <a href="#user"><img className="circle" src={props.profile.img} /></a>
          <a href="#name"><span className="white-text name">{props.profile.lastName} {props.profile.firstName}</span></a>
